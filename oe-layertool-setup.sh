...
EOM
    ...
    echo -e "\t$sourcedir/meta-ros \\" >> $confdir/bblayers.conf
    ...
    echo -e "\t$sourcedir/meta-browser \\" >> $confdir/bblayers.conf
    echo -e "\t$sourcedir/meta-qt5 \\" >> $confdir/bblayers.conf
    echo -e "\t$sourcedir/meta-virtualization \\" >> $confdir/bblayers.conf
    ...
    echo -e "\t$sourcedir/meta-openembedded/meta-multimedia \\" >> $confdir/bblayers.conf
    echo -e "\t$sourcedir/meta-openembedded/meta-filesystems \\" >> $confdir/bblayers.conf
